...
2. Parse the information on the file and make sure that each metadata piece can be extracted when we eventually move them to the excel sheet in the future
